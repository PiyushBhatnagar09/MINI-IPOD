...
/*
ZingTouch helps recognize various touch gestures, such as tapping, swiping, pinching, and rotating.
*/
...
class App extends React.Component {
  ...
  constructor() {
    /*
    In React, when you create a class component, you often extend the React.Component class. When you do this, 
    you need to call the constructor of the parent class (React.Component) using super() before defining the 
    constructor of your own class. This is because your class is a subclass of React.Component, and super() 
    calls the constructor of the parent class, allowing you to set up and initialize the base functionality 
    provided by React.Component.
    */
    super();

    // State
    //Audio is element of HTML5 and we are using it play, pause song
    ...
    this.state = {
      ...
      menu: {
        ...
        options: [
          ...
          {
            settings: ["change-wallpaper", "change-theme"]
          }
        ],
